...
If you discover a security vulnerability, please report it via [GitHub Issues](https://github.com/visterion/HiveMem/issues). Include steps to reproduce and potential impact.
