...
[![Tests](https://img.shields.io/badge/tests-264%20passed-brightgreen)](https://github.com/visterion/HiveMem/actions/workflows/ci.yml)
[![MCP Tools](https://img.shields.io/badge/MCP%20tools-38-orange)](https://github.com/visterion/HiveMem#tool-list-full)
...
docker run -d --name hivemem \
  ...
  ghcr.io/visterion/hivemem:main
```
