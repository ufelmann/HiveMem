...
1. **Separate benchmark host.** Prod HiveMem on the container stays untouched. Each benchmark run starts with a fresh database container (no cross-run contamination). Iteration on embedding models / ranking weights happens here without risking prod.
