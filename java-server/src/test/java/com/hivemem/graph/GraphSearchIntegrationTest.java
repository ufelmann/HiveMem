...
class GraphSearchIntegrationTest {
    ...
    void quickFactsFindsEntityAsSubjectAndAsObject() {
        // "GraphEntity2 uses Java" and "Mika created GraphEntity2"
        writeToolService.kgAdd(WRITER, "GraphEntity2", "uses", "Java", 1.0d, null, "committed", BASE_TIME, null);
        writeToolService.kgAdd(WRITER, "Mika", "created", "GraphEntity2", 0.9d, null, "committed", BASE_TIME.plusSeconds(1), null);
        ...
        // As object
        assertThat(subjects).contains("Mika");
